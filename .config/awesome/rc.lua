...
beautiful.init("/home/sanfred/.config/awesome/theme/theme.lua")
...
mymainmenu = awful.menu({ items = {
	...
	{"Ska bokföras",    "/usr/bin/nautilus \"ownCloud/Ombetro HB/4. Ska bokföras\"","/usr/share/icons/gnome/256x256/places/folder.png"},
	{ "", height="1" },
...
mytextclock = wibox.widget.textclock("  %a v%V - %d %b - %H:%M:%S  ", 1)
